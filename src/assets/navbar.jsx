          ...
          <div className="bg-[#3A3A3A] max-w-[80%] md:max-w-md text-white p-6 rounded-lg w-full mx-4">
            ...
            <form className="space-y-4">
              ...
              <div className="flex space-x-3">
                <button
                  type="submit"
                  className="max-w-[40%] sm:max-w-full flex-1 text-xs sm:text-2xl bg-green-600 text-white p-3 rounded hover:bg-green-600"
                >
                  Conecteaza-te
                </button>
                <button
                  ...
                  className="max-w-[40%] sm:max-w-full flex-1 text-xs sm:text-2xl bg-gray-500 text-white p-3 rounded hover:bg-gray-500"
                >
                  Inchide
                </button>
              </div>
          ...
          <div className="bg-[#3A3A3A] p-6 rounded-lg w-full max-w-[80%] md:max-w-md mx-4">
            ...
            <form className="space-y-4">
              ...
              <div className="flex space-x-3">
                <button
                  type="submit"
                  className="max-w-[40%] sm:max-w-full flex-1 text-xs sm:text-2xl bg-green-600 text-white p-3 rounded hover:bg-green-700"
                >
                  Inregistreaza-te
                </button>
                <button
                  ...
                  className="max-w-[40%] sm:max-w-full flex-1 text-xs sm:text-2xl bg-gray-500 text-white p-3 rounded hover:bg-gray-600"
                >
                  Inchide
                </button>
              </div>
